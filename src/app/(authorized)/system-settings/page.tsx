      ...
      render: (_: unknown, r: MachinePatternRow) => (
        <div className="flex items-center gap-1">
          ...
          <Button
            type="text"
            icon={<EditOutlined />}
            onClick={() => openEditMachinePattern(r)}
          />
          <Button
            type="text"
            danger
    ...
    <div className="p-6">
      ...
      >
        <div className="text-gray-700">
          This will remove{" "}
          <span className="font-semibold">
            {machinePatternDeletingRow?.patternName}
          </span>
          .
        </div>
      </Modal>
        ...
        {machinePatternDetailRow && (
          <div className="space-y-3">
            <div>
              ...
              <div className="font-medium text-gray-900">
                {machinePatternDetailRow.patternName}
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <div className="font-medium text-gray-900">
                  {machinePatternDetailRow.machineCount} machines
                </div>
              </div>
              <div>
                <div className="text-xs text-gray-500">Operating Hours</div>
                <div className="font-medium text-gray-900">
                  {machinePatternDetailRow.operatingHours} hours
                </div>
              </div>
              <div>
                <div className="text-xs text-gray-500">Status</div>
